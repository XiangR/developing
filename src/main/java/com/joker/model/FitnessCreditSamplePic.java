...
public class FitnessCreditSamplePic {
    ...
    public static void test2() {
        List<FitnessCreditSamplePic> fitnessCreditSamplePicList = Lists.newArrayList();
        {
            ...
            fitnessCreditSamplePic.setPicUrlList(Lists.newArrayList("http://p1.meituan.net/scarlett/1176ff9949945c214da374b7c5188d41618095.png"));
        ...
        }
        {
            ...
            fitnessCreditSamplePic.setPicUrlList(Lists.newArrayList("http://p0.meituan.net/scarlett/f6352dfc4ff877bfaa49175ef9f6ad0d448997.png"));
            fitnessCreditSamplePicList.add(fitnessCreditSamplePic);
        }
        {
            FitnessCreditSamplePic fitnessCreditSamplePic = new FitnessCreditSamplePic();
            ...
            fitnessCreditSamplePic.setPicUrlList(Lists.newArrayList("http://p0.meituan.net/scarlett/822bcfed6249e95d88d30053cdd8ae25763751.png", "http://p0.meituan.net/scarlett/fba2565c825dfe589d8948112e2bfb18734820.png"));
        ...
        }
        {
            ...
            fitnessCreditSamplePic.setPicUrlList(Lists.newArrayList("http://p0.meituan.net/scarlett/af42f25524f56a33f166e6ad7e02791c936990.png"));
            fitnessCreditSamplePicList.add(fitnessCreditSamplePic);
        }
        {
            FitnessCreditSamplePic fitnessCreditSamplePic = new FitnessCreditSamplePic();
            ...
            fitnessCreditSamplePic.setPicUrlList(Lists.newArrayList("http://p0.meituan.net/scarlett/0ecb49a8bf4c5ca7969ff06a5414a2ba225587.png", "http://p0.meituan.net/scarlett/8e3425e0a989fb535a5d28d4f9552b075779617.png"));
            fitnessCreditSamplePicList.add(fitnessCreditSamplePic);
        }
        {
            FitnessCreditSamplePic fitnessCreditSamplePic = new FitnessCreditSamplePic();
            ...
            fitnessCreditSamplePic.setPicUrlList(Lists.newArrayList("http://p0.meituan.net/scarlett/8ca4e11cb6d35a92633b81b58f513d4a1583359.png"));
        ...
        }
        {
            ...
            fitnessCreditSamplePic.setPicUrlList(Lists.newArrayList("http://p0.meituan.net/scarlett/19d0549cd2150d51c15de415b6867388360881.png"));
            fitnessCreditSamplePicList.add(fitnessCreditSamplePic);
        }
        {
            FitnessCreditSamplePic fitnessCreditSamplePic = new FitnessCreditSamplePic();
            ...
            fitnessCreditSamplePic.setPicUrlList(Lists.newArrayList("http://p0.meituan.net/scarlett/4f1baa1af2adca5003b2ad27c7ee04d0235804.png"));
            fitnessCreditSamplePicList.add(fitnessCreditSamplePic);
        }
        {
            FitnessCreditSamplePic fitnessCreditSamplePic = new FitnessCreditSamplePic();
            ...
            fitnessCreditSamplePic.setPicUrlList(Lists.newArrayList("http://p0.meituan.net/scarlett/7d3dacc704d5f77be202ad530359678e45022.jpg"));
            fitnessCreditSamplePicList.add(fitnessCreditSamplePic);
        }
        {
            FitnessCreditSamplePic fitnessCreditSamplePic = new FitnessCreditSamplePic();
            ...
            fitnessCreditSamplePic.setPicUrlList(Lists.newArrayList("http://p1.meituan.net/scarlett/50711fc3c210e10bd3065b8ce747418d200388.png"));
            fitnessCreditSamplePicList.add(fitnessCreditSamplePic);
        }
        {
            FitnessCreditSamplePic fitnessCreditSamplePic = new FitnessCreditSamplePic();
        ...
        }
        {
            ...
            fitnessCreditSamplePic.setPicUrlList(Lists.newArrayList("http://p0.meituan.net/scarlett/ab9a55ce99b335474e5f0c81abffb9f01609795.png"));
            fitnessCreditSamplePicList.add(fitnessCreditSamplePic);
        }
        {
            FitnessCreditSamplePic fitnessCreditSamplePic = new FitnessCreditSamplePic();
        ...
        }
        {
            ...
            fitnessCreditSamplePic.setPicUrlList(Lists.newArrayList("http://p1.meituan.net/scarlett/6af2ccdea21e8b1bd7b7e9a485ae14924581125.png"));
        ...
        }
        {
            ...
            fitnessCreditSamplePic.setPicUrlList(Lists.newArrayList("http://p0.meituan.net/scarlett/1e21af59f03dd2a7b715f4e4f6fe5eea5846159.png"));
            fitnessCreditSamplePic.setCreditDetectionUrl("https://www.crossfit.com/");
            fitnessCreditSamplePicList.add(fitnessCreditSamplePic);
        }
        {
        ...
        }
        {
            ...
            fitnessCreditSamplePic.setPicUrlList(Lists.newArrayList("http://p1.meituan.net/scarlett/1e7e985096114049c044ed3c408aa07c217625.png"));
            fitnessCreditSamplePicList.add(fitnessCreditSamplePic);
        }
